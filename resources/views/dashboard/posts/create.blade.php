...
<div class="col-lg-8">
        <form action="/dashboard/posts" method="post" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{ old('slug') }}" dissabled readonly required>
                @error('slug')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
...
<script>
    ...
    // nonaktifkan fungsi update file trix
